...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        self.add_argument("--enable_cutoff", action='store_true',
                          help='Enable cutoff pruning in branch and bound. When global lower bound is greater than cutoff value, stop exploring current branch.',
                          hierarchy=h + ["cutoff", "enabled"])
        self.add_argument("--cutoff_value", type=float, default=0.0,
                          help='Cutoff value for pruning in branch and bound. Default is 0.0 (prune when lb > 0).',
                          hierarchy=h + ["cutoff", "value"])
